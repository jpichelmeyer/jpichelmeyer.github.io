...
def copy_all_files_to_central(
    ...
    postfix:str="2026_04_14_g",
    postfix_indent:int=0,
    verbose:bool=False,
    overly_verbose:bool=False,
    live:bool=False,
    ):
    ...
    for path_abs in path_abs_files:
        ...
        if os.path.isfile(destination):
            print(f"............ALREADY.A.FILE.WITH.SAME.FILENAME.AT.DESTINATION....")
        else:
            if verbose:
...
if __name__ == '__main__':
    ...
    copy_all_files_to_central(verbose=True, overly_verbose=False, live=True)
