...
/*
    APP_REGISTRY  — the single source of truth for all registered apps.
    Apps register themselves at boot via registerApplication().

    DOCK_ORDER    — controls left-to-right render order in the dock.
                    'restart' is always the built-in terminal entry.
*/
...
export function registerApplication(appConfig) {
    // Unwrap module-style export if needed
    ...
    // Insert before 'restart' so restart stays last
