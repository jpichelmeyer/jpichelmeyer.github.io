...
/*
    attachDrag(winEl)
    ─────────────────
    Attaches drag-to-move behaviour to a window element.
    The drag handle is the element inside winEl that carries
    the [data-drag-target] attribute — currently .pos-sidebar-tab.

    Clicks on .pos-tl buttons are excluded so controls still fire.
    Dragging is blocked when the window is maximized.
*/
