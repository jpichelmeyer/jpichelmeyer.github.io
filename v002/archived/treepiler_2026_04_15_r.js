...
/*
=====================================================================
    TreePiler — text editor + PAST (Pichelmeyer Abstract Syntax Tree)
    
    Languages: Python, C#, Pseudocode
    
    Features:
      - Line-numbered editor with syntax highlighting overlay
      - Language-aware tokeniser + keyword highlighter
      - PAST builder (Pichelmeyer Abstract Syntax Tree)
      - Interactive canvas AST renderer with pan/zoom
=====================================================================
*/

//import { registerApplication } from '../../../index.js';
