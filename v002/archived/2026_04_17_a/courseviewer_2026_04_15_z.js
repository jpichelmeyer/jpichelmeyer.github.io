/*
=====================================================================
    v002/pos/app/course-viewer/course-viewer.js
=====================================================================
    CourseViewer — a POS application that renders a teaching
    portfolio: course grid → course detail → lesson viewer,
    all inside one window.

    Dependency: loaded by pos.js via launchTeaching().
    Data source: pos/app/course_viewer/courses.json
=====================================================================
*/
...
export const APP_REGISTRATION = {
    	...
    	launch: (body) => {
        	body.innerHTML = `
            	<div class="course-viewer-layout" style="display: flex; height: 100%; font-family: 'Outfit', sans-serif;">
                	<!-- Sidebar -->
                	<div class="course-sidebar" style="width: 200px; border-right: 1px solid #333; padding: 15px; background: rgba(0,0,0,0.2);">
                    	<h3 style="font-size: 14px; color: var(--app-accent); margin-bottom: 10px; text-transform: uppercase;">Curriculum</h3>
                    	<ul style="list-style: none; padding: 0; font-size: 13px; line-height: 2;">
                        	<li style="cursor: pointer; color: #fff;">01: Introduction</li>
                        	<li style="cursor: pointer; color: #888;">02: Core Concepts</li>
                        	<li style="cursor: pointer; color: #888;">03: Advanced Theory</li>
                    	</ul>
                	</div>
                	<!-- Main Content -->
                	<div class="course-main" style="flex: 1; padding: 25px; overflow-y: auto;">
                    	<h1 style="margin-top: 0;">Welcome to the Course</h1>
                    	<p style="color: #ccc; line-height: 1.6;">
                        	Select a module from the sidebar to begin your learning journey. 
                        	This viewer supports markdown rendering and interactive code snippets.
                    	</p>
                    	<div style="margin-top: 20px; padding: 15px; background: #222; border-left: 4px solid var(--app-accent);">
                        	<code style="font-family: 'Share Tech Mono';">System.load("Knowledge_Base");</code>
                    	</div>
                	</div>
            	</div>
        	`;
