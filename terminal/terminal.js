...
(function () {
    ...
    const cliMsgInitial = styles.getPropertyValue('--cliMsgInitial').trim();
    const cliColorPOS   = styles.getPropertyValue('--cliColorPOS').trim()   || '#bfff70';
    const cliCmdPrefix  = styles.getPropertyValue('--cliCmdPrefix').trim()  || '$>';
    ...
    function getAsciiCanvas(width = 10, height = 10, char = '.') {
